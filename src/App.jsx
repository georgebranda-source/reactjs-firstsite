  ...
  return (
    <div>
      <header style={{display: "flex", alignItems: "center", padding: "1rem"}}>
        <h1 style={{}}> Canadian International Trade Dashboard </h1>
      ...
      <div style ={{display: "flex", flexWrap: "wrap", gap: "2rem", marginLeft: "2rem"}}>
        <div className="chart-container" style={{flex: 1, minWidth: 650}}> 
          <h2> Normalized Trade Data </h2>
          <p> Displayed in percentage of value at earliest selected date </p>
          <div className="chart-wrapper"style={{position: "relative", width: 650, height: 400, display:"flex", alignItems: "center", justifyContent: "center"}}>
